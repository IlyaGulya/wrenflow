...
| Native accessibility tree | `mise run hardening-accessibility` | The signed app publishes a non-empty, measured AppScreens tree through the Swift NSAccessibility bridge and exits cleanly. |
