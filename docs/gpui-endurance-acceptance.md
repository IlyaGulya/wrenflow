...
| L02 | On an explicitly disposable data root, current-format corruption fails closed and the explicit current-data reset path restores a clean launch; no user data or TCC state is touched |
